                    ...
                    <div class="aa-product-area">
                        <div class="aa-product-inner">
                            ...
                            <ul class="nav nav-tabs aa-products-tab">
                                ...
                                <li><a href="#macbook" data-toggle="tab">Macbook</a></li>
...
<!--                                                <div class="aa-product-number-sold-wrapper">
                                ...
                                <div class="tab-pane fade" id="macbook">
                                    <ul class="aa-product-catg">
                                        <!-- start single product item -->
                                        <c:forEach items="${macbook}" var="product" end="7">
                                            <li>
                                                <c:forEach items="${product_sellings}" var="i">
                                                    <c:if test="${product.id == i.id}">
...
<!--                                <div class="tab-pane fade" id="vivo">
                                ...
                                <div class="tab-pane fade" id="phukien">
                                    <ul class="aa-product-catg">
                                        <!-- start single product item -->
                                        <c:forEach items="${other}" var="product" end="8">
                                            <li>
                                                <c:forEach items="${product_sellings}" var="i">
                                                    <c:if test="${product.id == i.id}">
                                                        <span class="aa-product-selling">Hot</span> 
            ...
            <div class="col-md-12">        
                <div class="row">
                    <div class="aa-banner-area">
                        <a href="#"><img src="${url}/images/banner 2.jpg" alt="banner trang chủ"></a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- / popular section -->
<!-- Support section -->
<section id="aa-support" style="background-color: #FFCD46">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="aa-support-area">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="aa-support-single">
                            ...
                            <P>Nhanh chóng - Dễ dàng - Thuận lợi</P>
                        </div>
                    </div>
                    <!-- single support -->
                    <div class="col-md-4 col-sm-4 col-xs-12">
