...
<!-- start header top  -->
<div class="aa-header-top" style="background-color: yellow; color: black; border-bottom: 0px">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="aa-header-top-area">
                    ...
                    <div class="aa-header-top-left">
                        <div class="cellphone hidden-xs">
                            <p><span class="fas fa-home"></span>Chào mừng đến với T&T Store</p>
                        </div>
                        <!-- start language -->
...
<!--                                <li class="hidden-xs"><a href="${pageContext.request.contextPath}/view/client/register">Đăng ký</a></li>-->
                                <li><a href="${pageContext.request.contextPath}/admin/login" style="color: black;">Đăng nhập</a></li>
                                </c:if>
