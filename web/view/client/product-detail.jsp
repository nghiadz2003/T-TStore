                ...
                <div class="aa-product-details-area">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <div class="aa-product-view-content">
                                    ...
                                    <p class="aa-product-detail-info">${detail_product.sold} sản phẩm đã bán</p>
                                    <div class="aa-price-block" style="padding-top: 0px">
                                        <c:forEach items="${product_sellings}" var="i">
                                            <c:if test="${detail_product.id == i.id}">
                                                <p class="aa-product-detail-selling">Bán chạy</p> 
                                            </c:if>
                                        </c:forEach> 
                                        <p class="aa-product-avilability">Trạng thái: 
                                            <c:choose>
                                        ...
                                        <p>Tình trạng: ${detail_product.description}</p>
                                    ...
                                    <div class="aa-prod-view-bottom">
                                        ...
                                        <c:if test="${detail_product.inventory != '0'}">
                                            <a class="aa-product-detail-selling" href="https://www.facebook.com/profile.php?id=61555406675527">Liên hệ ngay</a>
                                        </c:if>
                                        <c:if test="${detail_product.inventory == '0'}">
                    ...
                    <div class="aa-product-details-bottom">
                        <ul class="nav nav-tabs aa-products-tab" id="myTab2">
                            ...
                            <li class=""><a href="#tinhtrang" data-toggle="tab" class="">Tình trạng</a></li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="tinhtrang">
                                <p class="aa-product-detail-content">
                                ...
                                <ul style="padding-left: 30px; list-style: none;">
                                    <li style="margin-bottom: 8px; display: flex; align-items: center;">
                                        ...
                                        <strong>Máy 98%:</strong> Các máy cấn móp, xước sâu nhiều.
                                    </li>
                                    <li style="margin-bottom: 8px; display: flex; align-items: center;">
                                        <i class="fas fa-thumbs-up" style="color: #27ae60; margin-right: 10px;"></i>
                                        <strong>Máy 99%:</strong> Các máy gần như mới, có vài vết xước nhẹ nhỏ.
                                    </li>
                                    <li style="margin-bottom: 8px; display: flex; align-items: center;">
                                        <i class="fas fa-star" style="color: #f1c40f; margin-right: 10px;"></i>
                                        <strong>Máy New 100%:</strong> Các máy mới chưa Active (không box).
                                    </li>
                                </ul>
                                </p>
                            </div>
